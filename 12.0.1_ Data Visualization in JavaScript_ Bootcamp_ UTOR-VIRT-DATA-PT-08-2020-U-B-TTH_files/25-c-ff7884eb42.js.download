...
t.d(a,"completeUpload",(function(){return h}))
t.d(a,"submissionCommentAttachmentsUpload",(function(){return m}))
t.d(a,"uploadFiles",(function(){return g}))
function d(e){if("Network Error"===e.message){const a=new Error(c.t("Canvas failed to initiate the upload."))
a.originalError=e
return Promise.reject(a)}return Promise.reject(e)}function f(e){if("Network Error"===e.message){const a=new Error(c.t("Unable to transmit file to the storage service. The service may be down or you may need to re-login to Canvas."))
a.originalError=e
return Promise.reject(a)}return Promise.reject(e)}function p(e){if("Network Error"===e.message){const a=new Error(c.t("Canvas failed to complete the upload."))
a.originalError=e
return Promise.reject(a)}return Promise.reject(e)}function v(e,a,t){let n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:i["a"]
...
a.no_redirect=true
a["attachment[context_code]"]&&(a=l.a.stringify(a))
return n.post(e,a).catch(d).then(e=>h(e.data,t,{ajaxLib:n,onProgress:r}))}function h(e,a){let t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
const o=t.ajaxLib||i["a"]
const s=t.ajaxLibOptions||{}
...
Object.entries(m).forEach(e=>{let a=Object(r["a"])(e,2),t=a[0],n=a[1]
return y.append(t,n)})
a&&y.append(h,a,t.filename)
const k=o.post(c,y,Object(n["a"])({responseType:b?"document":"json",onUploadProgress:t.onProgress,withCredentials:!b},s))
return k.catch(f).then(e=>{if(d)return Object(u["a"])(d,{ajaxLib:o}).catch(p)
let a,n={}
if(g){const t=e.data,r=t.Bucket,i=t.Key,o=t.ETag
a=g
...
return o.get(a).then(e=>{let a=e.data
return a}).catch(p)}return e.data})}function m(e,a,t){const n="/api/v1/courses/".concat(a,"/assignments/").concat(t,"/submissions/self/comments/files")
const r=e.map(e=>{const a={name:e.name,content_type:e.type}
return v(n,a,e)})
return Promise.all(r)}function g(e,a){const t=e.map(e=>e.url?v(a,{url:e.url,name:e.title,content_type:e.mediaType,submit_assignment:false}):v(a,{name:e.name,content_type:e.type},e))
...
//# sourceMappingURL=25-c-ff7884eb42.js.map